...
const FeaturedPostCard = ({ post }) => (
  <div className="relative h-60 sm:h-72 mt-10">
    <div className="absolute rounded-lg bg-center bg-no-repeat bg-cover shadow-md inline-block w-full h-60 sm:h-72" style={{ backgroundImage: `url('${post.featuredImage.url}')` }} />
