        ...
        <div className="bg-white rounded-lg shadow-lg p-4 sm:p-8 mb-8 pb-12 text-sm sm:text-base">
            ...
            {categories.map((category) =>(
               <Link key={category.slug}  href={`/category/${category.slug}`}>
                   <span className="cursor-pointer font-bold inline-block bg-pink-600 rounded-full text-white px-4 py-2 m-1 hover:shadow-lg hover:-translate-y-1 hover:bg-indigo-700 active:scale-90 transition duration-150">
